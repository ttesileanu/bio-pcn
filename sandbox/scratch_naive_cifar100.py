# %% [markdown]
# # Quick comparison of PCN and BioPCN on CIFAR100
...
dataset = load_torchvision(
    "CIFAR100", n_validation=1000, dataset_kws={"transform": transforms.ToTensor()}
)
...
biopcn_optimizer = multi_lr(
    torch.optim.SGD, biopcn_net.parameter_groups(), lr_factors={"Q": 3.5 * 10}, lr=0.004
)
lr_power = 1.0
lr_rate = 4e-4
